...
(function ($) {
    ...
    function updateThemeSetting(id) {
        if ($("#light-mode-switch").prop("checked") == true && id === "light-mode-switch") {
            ...
            if($("#bootstrap-style").attr('href') != '/static/css/bootstrap.min.css')
                $("#bootstrap-style").attr('href', '/static/css/bootstrap.min.css');
            $('html').attr('data-bs-theme', 'light');
            if($("#app-style").attr('href') != '/static/css/app.min.css')
            ...
            $("#dark-mode-switch").prop("checked", false);
            $("#dark-rtl-mode-switch").prop("checked", false);
            if($("#bootstrap-style").attr('href') != '/static/css/bootstrap-rtl.min.css')
                $("#bootstrap-style").attr('href', '/static/css/bootstrap-rtl.min.css');
            if($("#app-style").attr('href') != '/static/css/app-rtl.min.css')
